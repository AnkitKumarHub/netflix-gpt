  ...
  return (
    <div className="aspect-video absolute w-screen text-white bg-gradient-to-r from-slate-950 p-8 transition-all duration-500 ease-in-out ">
      ...
      <div className="relative md:mx-32 mx-8 mt-4">
        ...
        >
          <p className="text-xl font-mono w-1/3">{isExpanded ? overview : getShortText(overview, wordLimit)}</p>
        </div>
      ...
      <div className="md:mx-32 mx-8 mt-6 md:mt-10 text-sm md:text-lg text-white flex gap-4">
        {/* Play Button */}
        <button className=" flex items-center gap-2 bg-white text-black px-6 py-3 rounded-lg backdrop-blur-lg transition-all duration-300 hover:bg-white/60 hover:scale-105">
          {/* <Play size={18} /> */}
          <img src="data:image/png;base64," alt="play--v1"></img>Play
        </button>
